...
struct CleanEventsView: View {
  ...
  var body: some View {
      VStack{
          ...
          Text("You have\n\(String(viewModel.events.count)) events today").foregroundColor(.white).font(.largeTitle).multilineTextAlignment(.center)
          Spacer()
...
struct CleanEventsView_Previews: PreviewProvider {
    static var previews: some View {
        CleanEventsView(viewModel: ViewModel())
    }
}
