      ...
      VStack{
        ...
        Text("Repeat the following sentences:")
          ...
          RoundedRectangle(cornerRadius: 25.0, style: .circular)
              .fill(rectColors[1])
              .overlay(
                Text("\(viewModel.affirmations[1].text)").multilineTextAlignment(.center)
                    .foregroundColor(.white)
              ).frame(width: 350, height: 75)
          RoundedRectangle(cornerRadius: 25.0, style: .circular)
              .fill(rectColors[0])
              .overlay(
                Text("\(viewModel.affirmations[2].text)").multilineTextAlignment(.center)
                    .foregroundColor(.white)
        ).frame(width: 350, height: 75)
          RoundedRectangle(cornerRadius: 25.0, style: .circular)
              .fill(rectColors[1])
              .overlay(
                Text("\(viewModel.affirmations[3].text)").multilineTextAlignment(.center)
                    .foregroundColor(.white)
              ).frame(width: 350, height: 75)
          RoundedRectangle(cornerRadius: 25.0, style: .circular)
              .fill(rectColors[0])
              .overlay(
                Text("\(viewModel.affirmations[4].text)").multilineTextAlignment(.center)
                    .foregroundColor(.white)
              )
              .frame(width: 350, height: 75)
        Spacer()
